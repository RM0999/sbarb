...
SPORT_KEYS = {'EPL (Soccer)': 'soccer_epl', 'UEFA Champions League': 'soccer_uefa_champs_league', 'La Liga (Soccer)': 'soccer_spain_la_liga', 'Serie A (Soccer)': 'soccer_italy_serie_a', 'NBA': 'basketball_nba', 'NCAA Basketball': 'basketball_ncaab', 'ATP Tennis': 'tennis_atp', 'WTA Tennis': 'tennis_wta', 'AFL': 'aussie_rules_afl', 'NFL': 'americanfootball_nfl', 'UFC / MMA': 'mma_mixed_martial_arts', 'Cricket (T20I)': 'cricket_international_t20', 'MLB (Baseball)': 'baseball_mlb', 'Rugby (Union International)': 'rugby_union_international'}
